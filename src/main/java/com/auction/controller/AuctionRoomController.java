...
// khai báo bảng
    ...
    public void handlePlaceBid(ActionEvent event) {
        ...
        try {
            ...
            if (newBid > currentHighestBid) {
                ...
                Bidder tempBidder = new Bidder(0, currentUserFullName, "", currentUserFullName, "", 0);
                Bid newBidEntry = new Bid(tempBidder, newBid);
    ...
    private String currentUserFullName = "Người dùng";
