...
public class LoginController {
    ...
    private void chuyenManHinhAdmin(ActionEvent event, String username) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/auction/views/admin-dashboard.fxml"));
    ...
    private void chuyenManHinhBidder(ActionEvent event, String username) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/auction/views/bidder-dashboard.fxml"));
            Parent root = loader.load();
